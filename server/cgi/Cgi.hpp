...
/*   Updated: 2026/06/19 21:40:00 by alamjada         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
The flow is: fork → pipe setup → execve with env → write body to stdin → read response from stdout.
...
SCRIPT_FILENAME = /var/www/html/cgi-bin/router.py   (chemin réel du script exécuté)
PATH_INFO       = /user/create
